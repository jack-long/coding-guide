...
def about_docstring():
    ...
    '''
    print about_docstring.__doc__
    
def about_coding_style():
    """Coding style.
    ...
    """
    print about_coding_style.__doc__

def about_interactive_test():
    """Interactive test.
